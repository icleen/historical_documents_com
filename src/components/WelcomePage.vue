<template>
  <div class="column">
    <img src="/static/images/animedoc.png"/>
    <h1>Upload Your Historical Documents!</h1>
    <h2>You can transcribe, edit, and use our very own OCR engine for handwriting recognition!</h2>
